package com.timebusker.model.shop;
...
public class ShopGoods implements Serializable {
    ...
    public List<Date> getRangeTime() {
        rangeTime = new ArrayList<>();
        rangeTime.add(this.startTime);
        rangeTime.add(this.endTime);
        Collections.sort(rangeTime);
        return rangeTime;
    }

    public void setRangeTime(List<Date> rangeTime) {
        Collections.sort(rangeTime);
        this.startTime = rangeTime.get(0);
        this.endTime = rangeTime.get(1);
